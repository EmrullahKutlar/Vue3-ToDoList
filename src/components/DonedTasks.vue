<template>
  <div class="tab-pane fade show active d-flex flex-wrap justify-content-center" id="pills-all" role="tabpanel">
    <div class="alert alert-warning w-100" role="alert" v-if="donedTasks.length <= 0">
      There is no tasks yet.
    </div>
    <div class="card mb-4 me-3" v-else v-for="(item, index) in donedTasks" :key="index">
      <div class="card-body">
